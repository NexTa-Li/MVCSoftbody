...
public interface ModelConfig {
    ...
    static final double BOUNCINESS = 0.95; // 0.90 is a good value
    static final double SURFACE_FRICTION_COEFFICIENT = 0.02; // 0.01 is a good value
    static final int NUM_SOFTBODIES = 9;

    static final int NUM_POINTS = 32;
    static final double RADIUS = 10.0; // Radius of the softbodies during first tick, and their springs resting length
    ...
    static final double FINAL_PRESSURE = 70_000.0;

    static final int WALL_THICKNESS = 3;

    static final int TICKRATE = 240;
     ...
     */
    static final double MASS_POINT_RADIUS = 0.0; // How big each mass point is
